...
function AccordionManager(_ref) {
  ...
  var setExpandedState = useCallback(function (_ref2) {
    var id = _ref2.id,
  ...
  var toggleExpanded = useCallback(function (_ref3) {
    var id = _ref3.id;
  ...
  var registerFold = useCallback(function (_ref4) {
    var id = _ref4.id,
  ...
  var unregisterFold = useCallback(function (_ref5) {
    var id = _ref5.id;
    setFoldList(function (list) {
      return list.filter(function (t) {
        return t !== id;
...
function useAccordionFold(foldId) {
  ...
  return {
    ...
    toggleExpanded: useCallback(function () {
      return toggleExpanded({
        id: foldId
      });
    }, [foldId, toggleExpanded]),
    setExpandedState: useCallback(function (expanded) {
...
function useAccordion() {
  ...
  return _objectSpread2(_objectSpread2({}, context), {}, {
    expandAll: useCallback(function () {
      return setExpandedFolds(foldList);
    }, [setExpandedFolds, foldList]),
    collapseAll: useCallback(function () {
      return setExpandedFolds([]);
    }, [setExpandedFolds])
  });
}

var AccordionFoldSelf = /*#__PURE__*/styled.section.withConfig({
  displayName: "styled__AccordionFoldSelf",
  componentId: "sc-u4hrcc-0"
})(["display:grid;background:", ";border-radius:", ";"], themeVal('color.surface'), themeVal('shape.rounded'));
var AccordionFoldHeader = /*#__PURE__*/styled.header.withConfig({
  displayName: "styled__AccordionFoldHeader",
  componentId: "sc-u4hrcc-1"
})(["box-shadow:0 1px 0 0 ", ";"], themeVal('color.base-100a'));
var AccordionFoldTrigger = /*#__PURE__*/styled.button.withConfig({
  displayName: "styled__AccordionFoldTrigger",
  componentId: "sc-u4hrcc-2"
})(["display:flex;align-items:center;padding:", ";text-decoration:none;border:0;background:inherit;color:inherit;width:100%;cursor:pointer;", "{transition:transform 240ms ease-in-out;transform:", ";margin-left:auto;}"], glsp(), CollecticonChevronDownSmall, function (_ref) {
  var isExpanded = _ref.isExpanded;
  return isExpanded ? 'rotate(180deg)' : 'rotate(0deg)';
});
var AccordionFoldBody = /*#__PURE__*/styled.div.withConfig({
...
var AccordionFoldBodyInner = /*#__PURE__*/styled.div.withConfig({
  displayName: "styled__AccordionFoldBodyInner",
  componentId: "sc-u4hrcc-4"
})(["box-shadow:0 1px 0 0 ", ";background:", ";padding:", ";"], themeVal('color.base-100a'), themeVal('color.base-50a'), glsp());
...
function AccordionFoldCmp(_ref) {
  ...
  return /*#__PURE__*/React.createElement(AccordionFoldSelf, _extends({
    id: id
  }, rest), /*#__PURE__*/React.createElement(Try, _extends({
    contentId: contentId,
    fn: renderHeader
  }, fnBag), /*#__PURE__*/React.createElement(AccordionFoldHeader, null, /*#__PURE__*/React.createElement(Heading, {
    size: "small",
    as: headingAs
  }, /*#__PURE__*/React.createElement(AccordionFoldTrigger, {
    isExpanded: isExpanded,
    onClick: onTriggerClick,
    "aria-controls": contentId,
    "aria-expanded": isExpanded
  }, title, /*#__PURE__*/React.createElement(CollecticonChevronDownSmall, {
    title: isExpanded ? 'Contract accordion icon' : 'Expand accordion icon'
  }))))), /*#__PURE__*/React.createElement(AccordionFoldBody, {
    id: contentId,
    isExpanded: isExpanded,
    "aria-hidden": !isExpanded
  }, /*#__PURE__*/React.createElement(Try, _extends({
    fn: renderBody
  }, fnBag), /*#__PURE__*/React.createElement(AccordionFoldBodyInner, null, content))));
}
...
var AccordionFold = /*#__PURE__*/styled(AccordionFoldCmp).withConfig({
  displayName: "AccordionFold",
  componentId: "sc-ial1fl-0"
})([""]);

export { AccordionFold, AccordionFoldBodyInner, AccordionFoldHeader, AccordionFoldTrigger, AccordionManager, useAccordion, useAccordionFold };
