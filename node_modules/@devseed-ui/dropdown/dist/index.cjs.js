...
Object.defineProperty(TetherComponent$2, "__esModule", {
  value: true
});
TetherComponent$2.default = void 0;
...
var _tether = _interopRequireDefault(tether.exports);
...
function (_Component) {
  ...
  function TetherComponent() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf$1(TetherComponent)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized$1(_assertThisInitialized$1(_this)), "_targetNode", _react.default.createRef());

    _defineProperty(_assertThisInitialized$1(_assertThisInitialized$1(_this)), "_elementNode", _react.default.createRef());

    _defineProperty(_assertThisInitialized$1(_assertThisInitialized$1(_this)), "_elementParentNode", null);

    _defineProperty(_assertThisInitialized$1(_assertThisInitialized$1(_this)), "_tetherInstance", null);
  ...
  _createClass(TetherComponent, [{
    ...
    value: function _updateTether() {
      var _this$props2 = this.props;
          ...
          _this$props2.renderElementTag;
          _this$props2.renderElementTo;
          var id = _this$props2.id;
          _this$props2.className;
          var style = _this$props2.style;
          _this$props2.renderTarget;
          _this$props2.renderElement;
          var options = _objectWithoutProperties(_this$props2, ["children", "renderElementTag", "renderElementTo", "id", "className", "style", "renderTarget", "renderElement"]);
...
_defineProperty(TetherComponent$1, "propTypes", {
...
_defineProperty(TetherComponent$1, "defaultProps", {
  renderElementTag: 'div',
  renderElementTo: null
});

var _default = TetherComponent$1;
TetherComponent$2.default = _default;
...
var _TetherComponent = _interopRequireDefault(TetherComponent$2);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
}(reactTether));

var TetherComponent = /*@__PURE__*/getDefaultExportFromCjs(reactTether);
...
var _tint = themeProvider.stylizeFunction(curriedTint);
...
var DropContent = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "styled__DropContent",
  componentId: "sc-cioebn-0"
})(["background:", ";border-radius:", ";box-shadow:0 0 0 1px ", ",", ";position:relative;z-index:1000;width:100vw;max-width:14rem;padding:", ";text-align:left;color:", ";transition:opacity 0.16s ease,transform 0.16s ease;.tether-target-attached-top.tether-element-attached-bottom &{", " &.drop-trans-exit{", "}&.drop-trans-exit-active{", "}}.tether-target-attached-bottom.tether-element-attached-top &{", " &.drop-trans-exit{", "}&.drop-trans-exit-active{", "}}.tether-target-attached-right.tether-element-attached-left &{", " &.drop-trans-exit{", "}&.drop-trans-exit-active{", "}}.tether-target-attached-left.tether-element-attached-right &{", " &.drop-trans-exit{", "}&.drop-trans-exit-active{", "}}&&.drop-trans-appear,&&.drop-trans-enter{", "}&&.drop-trans-enter-active,&&.drop-trans-appear-active{", "}&&.drop-trans-exit{", "}&&.drop-trans-exit-active{", "}"], themeProvider.themeVal('color.surface'), themeProvider.themeVal('shape.rounded'), themeProvider.themeVal('color.base-100a'), themeProvider.themeVal('boxShadow.elevationD'), themeProvider.glsp(), themeProvider.themeVal('type.base.color'), transitions.up.end, transitions.up.end, transitions.up.start, transitions.down.end, transitions.down.end, transitions.down.start, transitions.right.end, transitions.right.end, transitions.right.start, transitions.left.end, transitions.left.end, transitions.left.start, function (_ref) {
  var direction = _ref.direction;
  return transitions[direction].start;
}, function (_ref2) {
  var direction = _ref2.direction;
  return transitions[direction].end;
}, function (_ref3) {
...
var dropTitleAttrs = function dropTitleAttrs(props) {
  return {
    as: props.as || 'h6'
  };
};

var DropTitle = /*#__PURE__*/styled__default["default"](typography.Overline).attrs(dropTitleAttrs).withConfig({
  displayName: "styled__DropTitle",
  componentId: "sc-cioebn-1"
})(["margin:", ";"], themeProvider.glsp(0, 0, 1, 0));
var DropMenu = /*#__PURE__*/styled__default["default"].ul.withConfig({
  displayName: "styled__DropMenu",
  componentId: "sc-cioebn-2"
})(["list-style:none;margin:", ";box-shadow:0 ", " 0 0 ", ";padding:", ";min-width:12rem;font-family:", ";font-weight:", ";&:last-child{margin-bottom:", ";box-shadow:none;}"], themeProvider.glsp(-1, -1, 1, -1), themeProvider.themeVal('layout.border'), themeProvider.themeVal('color.base-100a'), themeProvider.glsp(0.5, 0), themeProvider.themeVal('type.base.family'), themeProvider.themeVal('type.base.bold'), themeProvider.glsp(-1));
var DropMenuItem = /*#__PURE__*/styled__default["default"].a.withConfig({
  displayName: "styled__DropMenuItem",
  componentId: "sc-cioebn-3"
})(["position:relative;display:flex;gap:", ";align-items:center;padding:", ";color:", ";text-decoration:none;transition:all 0.16s ease 0s;&:visited{color:inherit;}&:hover,&:focus{color:", ";background-color:", ";opacity:1;}", " ", ""], themeProvider.glsp(0.5), themeProvider.glsp(0.25, 1), themeProvider.themeVal('type.base.color'), themeProvider.themeVal('color.link'), themeProvider.rgba(themeProvider.themeVal('color.link'), 0.12), function (_ref5) {
  var active = _ref5.active;
  return active && styled.css(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n      &,\n      &:visited {\n        background-color: ", ";\n        color: ", ";\n      }\n\n      &::before {\n        position: absolute;\n        top: 0;\n        left: 0;\n        width: 0.25rem;\n        height: 100%;\n        background: ", ";\n        content: '';\n        pointer-events: none;\n      }\n    "])), themeProvider.rgba(themeProvider.themeVal('color.link'), 0.08), themeProvider.themeVal('color.link'), themeProvider.themeVal('color.link'));
}, function (_ref6) {
  var d = _ref6.disabled;
  return d && styled.css(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n      ", ";\n    "])), themeProvider.disabled());
});
var DropInset = /*#__PURE__*/styled__default["default"].div.withConfig({
  displayName: "styled__DropInset",
  componentId: "sc-cioebn-4"
})(["background:", ";color:", ";box-shadow:inset 0 ", " 0 0 ", ",inset 0 -", " 0 0 ", ";margin:", ";padding:", ";&:first-child{box-shadow:inset 0 -", " 0 0 ", ";}&:last-child{margin-bottom:", ";box-shadow:inset 0 ", " 0 0 ", ";border-radius:0 0 ", " ", ";}&:only-child{box-shadow:none;}> *:first-child{margin-top:0;}> *:last-child{margin-bottom:0;}"], themeProvider.themeVal('color.base-50'), _tint(0.32, themeProvider.themeVal('type.base.color')), themeProvider.themeVal('layout.border'), themeProvider.themeVal('color.base-100a'), themeProvider.themeVal('layout.border'), themeProvider.themeVal('color.base-100a'), themeProvider.glsp(-1, -1, 1, -1), themeProvider.glsp(), themeProvider.themeVal('layout.border'), themeProvider.themeVal('color.base-100a'), themeProvider.glsp(-1), themeProvider.themeVal('layout.border'), themeProvider.themeVal('color.base-100a'), themeProvider.themeVal('shape.rounded'), themeProvider.themeVal('shape.rounded'));

var _excluded = ["direction", "alignment", "id", "className", "onChange", "triggerElement", "children"],
    _excluded2 = ["onChange"];
/**
...
var getTetherAttachments = function getTetherAttachments(direction, alignment) {
  var allowed;
  ...
  if (direction === 'up' || direction === 'down') {
    ...
    throw new Error("Dropdown: direction \"".concat(direction, "\" is not supported. Use one of: up, down, left, right"));
  }

  if (allowed.indexOf(alignment) === -1) {
    throw new Error("Dropdown: alignment \"".concat(alignment, "\" is not supported when direction is ").concat(direction, ". Use one of: ").concat(allowed.join(', ')));
  ...
  switch (direction) {
    case 'up':
      return ["bottom ".concat(alignment), "top ".concat(alignment)];

    case 'down':
      return ["top ".concat(alignment), "bottom ".concat(alignment)];

    case 'right':
      return ["".concat(alignment, " left"), "".concat(alignment, " right")];

    case 'left':
      return ["".concat(alignment, " right"), "".concat(alignment, " left")];
  }
...
var getClosest = function getClosest(el, cb) {
  do {
...
var getClosestInstance = function getClosestInstance(el) {
  return getClosest(el, function (element) {
    return element.hasAttribute('data-drop-instance');
  });
};
/**
...
var getClosestDropCloser = function getClosestDropCloser(el) {
  return getClosest(el, function (element) {
    var v = element.getAttribute('data-dropdown');
    return v === 'click.close';
  });
};

var useBodyListenerEffect = function useBodyListenerEffect(uuid, setOpen) {
  React.useEffect(function () {
    // Abort in case of SSR.
    if (typeof window === 'undefined') return;

    var listener = function listener(e) {
      var target = e.target; // Closer as in an element that can close the dropdown.

      var closerElement = getClosestDropCloser(target);

      if (target.tagName === 'BODY' || target.tagName === 'HTML' || closerElement) {
      ...
      var closestInstance = getClosestInstance(target);
      if (!closestInstance) return setOpen(false);
      var closestUuid = closestInstance.getAttribute('data-drop-instance');

      if (closestInstance.getAttribute('data-drop-el') === 'trigger' && closestUuid === uuid) {
        // If we're dealing with the trigger for this instance don't do anything.
        // There are other listeners in place.
        return;
      }

      if (closestInstance.getAttribute('data-drop-el') === 'content' && closestUuid === uuid) {
    ...
    }; // setOpen is a hook and won't change.
...
var Dropdown = /*#__PURE__*/React__default["default"].forwardRef(function (props, ref) {
  ...
  var uuid = React.useRef(Dropdown.generateUUID());
  var tetherRef = React.useRef(null);
  ...
  var _getTetherAttachments = getTetherAttachments(direction, alignment),
      _getTetherAttachments2 = _slicedToArray(_getTetherAttachments, 2),
      tetherAttachment = _getTetherAttachments2[0],
      tetherTargetAttachment = _getTetherAttachments2[1];
  ...
  var klasses = [className, 'drop__content', 'drop-trans', "drop-trans--".concat(direction)].filter(Boolean).join(' ');
  /* eslint-disable-next-line prefer-const */

  var dropdownContentProps = _objectSpread2({
    id: id || undefined,
    className: klasses,
  ...
  return /*#__PURE__*/React__default["default"].createElement(TetherComponent, {
    ref: tetherRef // attachment is the content.
    ,
    attachment: tetherAttachment // targetAttachment is the trigger
    ,
    ...
    renderTarget: function renderTarget(ref) {
      return triggerElement({
        ref: ref,
        // Ref from thether. Must be attached.
    ...
    renderElement: function renderElement(ref) {
      ...
      }, /*#__PURE__*/React__default["default"].createElement(TransitionItem, dropdownContentProps));
    }
  });
});
Dropdown.displayName = 'Dropdown'; // Use a static method to generate a uuid so it can be mocked during tests.

Dropdown.generateUUID = function () {
  return Math.random().toString(36).substr(2, 5);
};

Dropdown.closeAll = function () {
  return activeDropdowns.forEach(function (d) {
    return d.setOpen(false);
  });
};

Dropdown.defaultProps = {
  /* eslint-disable-next-line react/display-name */
  triggerElement: function triggerElement(props) {
...
Dropdown.propTypes = {
  ...
  triggerElement: PropTypes__default["default"].func,
  direction: PropTypes__default["default"].oneOf(['up', 'down', 'left', 'right']),
  alignment: PropTypes__default["default"].oneOf(['left', 'center', 'right', 'top', 'middle', 'bottom']),
...
function TransitionItem(props) {
  ...
  React.useEffect(function () {
    ...
    }; // onChange will not change in between mounts because the whole purpose of
    // TransitionItem is to be mounted/unmounted for animation.

    /* eslint-disable-next-line react-hooks/exhaustive-deps */
  }, []);
  return /*#__PURE__*/React__default["default"].createElement(DropContent, rest);
}
...
exports.DropInset = DropInset;
exports.DropMenu = DropMenu;
exports.DropMenuItem = DropMenuItem;
