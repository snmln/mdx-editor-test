...
declare module '@devseed-ui/modal' {
   ...
   * Renders `<header>`
   */
  function ModalHeader(props): JSX.Element;

  /**
   * Styled component for the modal headline.
   * Renders `<div>`
   */
  function ModalHeadline(props): JSX.Element;
   ...
   */
  function ModalToolbar(props): JSX.Element;

  /**
   * Styled component for the modal body.
   * Renders `<div>`
   */
  function ModalBody(props): JSX.Element;

  /**
   * Styled component for the modal footer.
   * Renders `<footer>`
   */
  function ModalFooter(props): JSX.Element;
}
