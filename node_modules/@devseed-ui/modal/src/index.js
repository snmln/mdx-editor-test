...
function Modal(props) {
  ...
  }, [revealed, onCloseClick, disableKeyboardClose]);
    ...
    >
      ...
      >
        ...
        <ModalContents className='modal__contents' size={size}>
          <Try fn={renderContents} {...fnBag}>
            <Try fn={renderHeader} {...fnBag}>
              <ModalHeader>
                <Try fn={renderHeadline} {...fnBag}>
                  <ModalHeadline>
                    <Heading size='small'>{title}</Heading>
                  </ModalHeadline>
                </Try>
                <Try fn={renderToolbar} {...fnBag}>
                  {closeButton && (
                    <ModalToolbar>
                      <Button
                        size='small'
                        ...
                        title='Close modal'
                      >
                        <CollecticonXmarkSmall title='Close modal' meaningful />
                      </Button>
                    </ModalToolbar>
                  )}
                </Try>
...
Modal.propTypes = {
  ...
  revealed: T.bool,
  className: T.string,
  size: T.oneOf(['small', 'medium', 'large', 'xlarge', 'fullscreen']),
  onOverlayClick: T.func,
  onCloseClick: T.func,
  closeButton: T.bool,
  disableKeyboardClose: T.bool,
  title: T.string,
